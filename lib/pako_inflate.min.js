...
!(function (e, t) {
  ...
  var f = (e, t, i, n, a, f, h, c) => {
      ...
      if ((E > x && (E = x), 0 === x))
        return (a[f++] = 20971520), (a[f++] = 20971520), (c.bits = 1), 0;
      for (y = 1; y < x && 0 === D[y]; y++);
      for (E < y && (E = y), Z = 1, v = 1; v <= r; v++)
        if (((Z <<= 1), (Z -= D[v]), Z < 0)) return -1;
  ...
  const B = (e) => {
      if (I) {
        ...
        for (f(1, e.lens, 0, 288, T, 0, e.work, { bits: 9 }), t = 0; t < 32; )
          e.lens[t++] = 5;
  ...
  var C = {
    ...
    inflate: (e, i) => {
      ...
      e: for (;;)
        switch (r.mode) {
            ...
            if (
              ...
              T &&
                (r.head &&
                  ...
                  r.head.extra.set(s.subarray(l, l + T), j)),
                512 & r.flags && (r.check = n(r.check, s, T, l)),
                (h -= T),
                (l += T),
                (r.length -= T)),
              r.length)
          ...
          case 14:
            ...
            if (
              ((r.length = 65535 & Z), (Z = 0), (S = 0), (r.mode = 15), i === w)
            )
              break e;
          case 15:
            r.mode = 16;
          ...
          case 19:
            ...
            if (
              ((r.lenbits = 9),
              (G = { bits: r.lenbits }),
              (K = f(1, r.lens, 0, r.nlen, r.lencode, 0, r.work, G)),
              (r.lenbits = G.bits),
              K)
            ) {
            ...
            if (
              ...
              (G = { bits: r.distbits }),
              (K = f(2, r.lens, r.nlen, r.ndist, r.distcode, 0, r.work, G)),
              (r.distbits = G.bits),
              K)
            ) {
          ...
          case 21:
            ...
            if (
              ((Z >>>= C), (S -= C), (r.back += C), (r.length = F), 0 === z)
            ) {
              r.mode = 26;
              break;
            }
      ...
      return (
        ...
        (r.bits = S),
        (r.wsize ||
          (U !== e.avail_out && r.mode < E && (r.mode < 27 || i !== c))) &&
          N(e, e.output, e.next_out, U - e.avail_out),
        (O -= e.avail_in),
        (U -= e.avail_out),
        (e.total_in += O),
        (e.total_out += U),
        ...
        r.wrap &&
          ...
          (e.adler = r.check =
            r.flags
              ? n(r.check, o, U, e.next_out - U)
              : t(r.check, o, U, e.next_out - U)),
        (e.data_type =
          r.bits +
          (r.last ? 64 : 0) +
          (r.mode === x ? 128 : 0) +
    ...
    inflateSetDictionary: (e, i) => {
      ...
      return e && e.state
        ? ((a = e.state),
          0 !== a.wrap && 11 !== a.mode
            ? _
            : 11 === a.mode && ((r = 1), (r = t(r, i, n, 0)), r !== a.check)
            ? g
            : ((s = N(e, i, n, n)),
              s ? ((a.mode = 31), v) : ((a.havedict = 1), b)))
        : _;
    },
  ...
  var j = (e) => {
      ...
      for (t = new Uint8Array(o), r = 0, a = 0; r < o; a++)
        (i = e.charCodeAt(a)),
          55296 == (64512 & i) &&
            a + 1 < s &&
            ((n = e.charCodeAt(a + 1)),
  ...
  function ne(e) {
    this.options = F({ chunkSize: 65536, windowBits: 15, to: "" }, e || {});
    ...
    if (
      ...
      t.dictionary &&
        ...
        t.raw &&
          ((i = C.inflateSetDictionary(this.strm, t.dictionary)), i !== Q)))
    )
      throw new Error(Y[i]);
  }
  function ae(e, t) {
  ...
  (ne.prototype.push = function (e, t) {
    ...
    for (
      ...
      for (
        0 === i.avail_out &&
          ...
          r === $ &&
            ...
            r === Q ? (r = C.inflate(i, s)) : r === te && (r = $));
        i.avail_in > 0 && r === V && i.state.wrap > 0 && 0 !== e[i.next_in];
      ...
      if (r !== Q || 0 !== o) {
        if (r === V)
          return (
            (r = C.inflateEnd(this.strm)), this.onEnd(r), (this.ended = !0), !0
          );
